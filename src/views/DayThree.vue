		...
		<v-row>
			...
			<v-col cols="12" class="main-text text-border">
				...
				<p class="h-l">
					...
					Douglas. No, it definitely did. You see, I lived in Hawaii for a time during those eight years and I was working on some personal issues relating to my divorce etc. So I looked up a psychologist, and made an appointment.
				</p>
				<p class="h-l">
					H.L. Okay.
				</p>
				...
				<p class="h-l">
					...
					Douglas. Yes, of course. So at first when I saw the font size of this Carlos Ghosn’s name increasing, I said to myself. “Well, you better be careful, because maybe they are interpreting the data incorrectly; they may think that he is interested. And you don’t want to get anyone in trouble; bring charges against him especially if this is all a misinterpretation”.
				</p>
				<p class="h-l">
				...
				<p>
					...
					D.L. That is amazing in a sad way. Basically you were one step ahead of them but they didn’t know it.
				</p>
				<p>
				...
				<p class="h-l">
					...
					Douglas; I don’t know, modern science is miraculous. The pharmacology of power is a heavily guarded and effective secret.
				</p>
				<p class="h-l">
				...
				<p class="h-l">
					...
					Douglas. Yes, in many ways, in many parts of the country it’s true.
				</p>
				<p class="h-l">
					H.L. I think so.
				</p>

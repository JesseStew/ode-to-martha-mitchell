      ...
      <v-row no-gutters>
        ...
        <v-col
         ...
         class="home-text" cols="12">
          ...
          <p class="px-5">
          The source of the scandal has its origins in 2014, with a letter I composed and sent to the thousands of the most powerful and wealthy individuals in the world; the letter was entitled <span class="italic">The Legacy Letter</span>. The purpose of this letter was to obtain funding for my 2006 book entitled, The Theorem: A Complete Answer to Human Behavior, which itself was based on a discovery made all the way back in 1994.
          </p>
          <p class="px-5">

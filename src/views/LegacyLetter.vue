            ...
            The Legacy Letter - (Actual Copy)
				...
				<v-col class="interview-color" cols="12">
					<p class="px-5 home-text">
						On this page you will be able to view a copy of an actual Legacy Letter sent to a potential donor or potential investor. While this copy was sent from Tennessee in 2014, others were sent from Missouri between 2015 and 2017. In total, approximately 10,100 copies of <span class="italic">The Legacy Letter</span> were sent out altogether; this from winter of 2014 to spring of 2017. While the most typical format; a short introduction tailed by a longer attachment or pdf, other times the complete letter was sent as a continuous email, as included below. In some instances, a shorter and more personal follow up correspondence was also sent months or even years later.
					</p>
					<p class="px-5 home-text">
						Obviously, in regards to the interview, <span class="italic">The Legacy Letter</span> was never intended to be included with the original presentation. This will become apparent to the reader right away as they undertake the interview and realize the description of <span class="italic">The Legacy Letter</span> contents. However, because there are no spatial limitations on this web presentation, we have included an actual copy for a more accurate reference.
					</p>
